...
This script launch cosmos (component interactive gallery tool).
In order to see the components open browser an go to [localhost (port: 8989)](http://localhost:8989)
